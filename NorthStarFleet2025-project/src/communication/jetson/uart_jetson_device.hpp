 ...
 */
 ...
 #ifndef TAPROOT_UART_JETSON_DEVICE_HPP_
 #define TAPROOT_UART_JETSON_DEVICE_HPP_
 
 #include "tap/communication/serial/uart.hpp"
 
 #include "modm/io/iodevice.hpp"

 #include "tap/communication/serial/uart_terminal_device_constants.hpp"
  ...
  */
 class UartJetsonDevice : public ::modm::IODevice
 {
 public:
     UartJetsonDevice(Drivers *drivers);
     DISALLOW_COPY_AND_ASSIGN(UartJetsonDevice);
     virtual ~UartJetsonDevice() = default;
 ...
 private:
     static constexpr Uart::UartPort JETSON_UART_PORT = Uart::UartPort::Uart6;
     static constexpr uint32_t UART_BAUDE_RATE = 115200;
 
     Drivers *drivers;
 };  // class UartJetsonDevice
 }  // namespace tap::communication::serial
 
 #endif  // TAPROOT_UART_JETSON_DEVICE_HPP_
